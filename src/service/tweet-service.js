...
class TweetService {
    ...
    async create(data) {
        ...
        const tags = content.match(/#[a-zA-Z0-9]+/g).map((tag)=> tag.substring(1).toLowerCase()) // this regex extracts hashtag and if any hashtag in capital then it converts into small
